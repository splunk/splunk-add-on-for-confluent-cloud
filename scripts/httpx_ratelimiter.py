...
from typing import TYPE_CHECKING, Union, Optional, List, Type, Dict, Any
...
class NameBucketFactory(BucketFactory):
    ...
    def __init__(  # noqa: PLR0913
        ...
        bucket_kwargs: Optional[Dict[str, Any]] = None,
        *args,
        **kwargs,
    ):
...
class LimiterMixin(MIXIN_BASE):
    ...
    def __init__(  # noqa: PLR0913
        ...
        per_month: float = 0,
        burst: float = 1,
        rates: Optional[Union[Rate, List[Rate]]] = None,
        bucket_class: Type[AbstractBucket] = InMemoryBucket,
        bucket_kwargs: Optional[Dict[str, Any]] = None,
...
def get_valid_kwargs(func: Callable, kwargs: Dict[str, Any]) -> Dict[str, Any]:
